...
public class CollisionTest {
    ...
    //Constructor for the case when the collision of two rectangles need to be checked multiple times
    public CollisionTest(Rectangle myRectangle,Rectangle rectangle) {
        this.myRectangle=myRectangle;
        this.rectangle=rectangle;
    }

    //Constructor for the case that one Rectangle need to check collisions with multiple objects
    ...
    //Method to check if the rectangle linked to the TestCollision object is colliding with the rectangle give with the argument
    ...
    //Method to check if the rectangle linked to the TestCollision object is colliding with a rectangular surface
    public boolean testCollision(double x, double y, double width, double height){
        return this.myRectangle.intersects(x,y,width,height);
    }

    //Method to check if the two linked Rectangles are colliding
    public boolean testCollision(){
        //ToDo Catch the case when there is no Rectangle;
